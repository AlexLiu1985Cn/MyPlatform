...
public class SummaryListActivity extends FixedActivity {
	 ...
	 */
	private XListView mAll, mNews, mBulletin, mActivity, mStrategy;
	/**
	...
	public BaseRequestBean[] needRequestDataBean() {
		...
		return new BaseRequestBean[] { allRequest, newsRequest, bulletinRequest, activityRequest, strategyRequest };
	}
