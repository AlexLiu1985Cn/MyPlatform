...
public class GiftSelfActivity extends ElasticityActivity{
	...
	public BaseRequestBean[] needRequestDataBean() {
		GiftSelfListRequest selfRequest = new GiftSelfListRequest(currentPage+"", pageSize, GameToPlatformParamsSaveUtil.getInstanse().getUser().getAccountName(),HttpParam.PHONE,HttpParam.PLATFORM_AREA);
	...
	private void updateGiftSelfStatus(){
		if(GameToPlatformParamsSaveUtil.getInstanse().isNewStatusOfGiftSelf() && allow){
	...
	private GiftSelfListRequest createRequest(int currentPage){
		++currentPage;
		GiftSelfListRequest request = new GiftSelfListRequest(currentPage+"", pageSize, GameToPlatformParamsSaveUtil.getInstanse().getUser().getAccountName(),HttpParam.PHONE,HttpParam.PLATFORM_AREA);
