...
public class CsReplyDetailsActivity extends FixedActivity implements OnClickListener {
	...
	public BaseRequestBean[] needRequestDataBean() {
		...
		} else if (requestFlag == CS_REPLY_COMMIT_QUESTION && mReplyQuestionBean != null && !EfunStringUtil.isEmpty(mEditText.getText().toString())) {
			replyContent = mEditText.getText().toString();
			CsReplyCommitQuestionRequest csRequest = new CsReplyCommitQuestionRequest(mReplyQuestionBean.getTgppid(), GameToPlatformParamsSaveUtil.getInstanse().getUser().getAccountName(), replyContent, HttpParam.CS_PLAYER, HttpParam.CS_CHECK, HttpParam.APP);
	...
	public void init(Bundle bundle) {
		...
		mReplyBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View paramView) {
				if (!EfunStringUtil.isEmpty(mEditText.getText().toString())) {
