...
public class CsCommendActivity extends FixedActivity implements OnClickListener {
	...
	public BaseRequestBean[] needRequestDataBean() {
		CsReplyCommitQuestionRequest csRequest = new CsReplyCommitQuestionRequest(pid, GameToPlatformParamsSaveUtil.getInstanse().getUser().getAccountName(), content, HttpParam.CS_PLAYER, HttpParam.CS_CHECK, HttpParam.APP);
